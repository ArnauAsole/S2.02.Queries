...
-- 46. List subjects taught in the first semester, third year, of degree ID 7
SELECT nombre FROM asignatura WHERE cuatrimestre = 1 AND curso = 3 AND id_grado = 7;

-- 47. List professors with their department name, ordered by name and surnames
SELECT p.apellido1, p.apellido2, p.nombre, d.nombre AS department FROM profesor pr JOIN persona p ON pr.id_profesor = p.id JOIN departamento d ON pr.id_departamento = d.id ORDER BY p.apellido1, p.apellido2, p.nombre;

-- 48. List subject names and academic years of the student with NIF '26902806M'
...
-- 49. List departments with professors teaching in the "Grado en Ingeniería Informática (Plan 2015)"
...
-- 50. List students enrolled in subjects during the 2018/2019 academic year
...
-- 51. List all professors and their departments, including those without one
...
-- 53. List departments with no associated professors
...
-- 55. List subjects without an assigned professor
...
-- 60. Number of professors per department (including departments without professors)
...
-- 61. Number of subjects per degree (including degrees with no subjects)
